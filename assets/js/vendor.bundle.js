  ...
  [2],
  {
    5: function (t, e, i) {
      ...
      function B(t, e, i) {
        ...
        e &&
          D(t) &&
          ((s = (t.offsetWidth > 0 && F(n.width) / t.offsetWidth) || 1),
          (o = (t.offsetHeight > 0 && F(n.height) / t.offsetHeight) || 1));
      ...
      function K(t) {
        return "html" === k(t)
          ? t
          : t.assignedSlot || t.parentNode || (I(t) ? t.host : null) || $(t);
      }
      function Q(t) {
        return D(t) && "fixed" !== q(t).position ? t.offsetParent : null;
      }
      function X(t) {
        for (var e = L(t), i = Q(t); i && V(i) && "static" === q(i).position; )
          i = Q(i);
        return i &&
          ("html" === k(i) || ("body" === k(i) && "static" === q(i).position))
          ? e
          : i ||
              (function (t) {
                var e = /firefox/i.test(H());
                if (/Trident/i.test(H()) && D(t) && "fixed" === q(t).position)
                  return null;
                var i = K(t);
                for (
                  I(i) && (i = i.host);
      ...
      function it(t) {
        ...
        var D,
          I = Object.assign({ position: u }, p && et),
          N =
            !0 === g
              ? (function (t, e) {
                  var i = t.x,
                  ...
                  return { x: F(i * s) / s || 0, y: F(n * s) / s || 0 };
                })({ x: b, y: y }, L(i))
              : { x: b, y: y };
        return (
          (b = N.x),
      ...
      function dt(t) {
        return B($(t)).left + ht(t).scrollLeft;
      }
      function ut(t) {
        var e = q(t),
          i = e.overflow,
        ...
        var s =
            "clippingParents" === e
              ? (function (t) {
                  var e = ft(K(t)),
                    i =
                      ["absolute", "fixed"].indexOf(q(t).position) >= 0 && D(t)
                        ? X(t)
                        : t;
                  return S(i)
                    ? e.filter(function (t) {
                        return S(t) && R(t, i) && "body" !== k(t);
                      })
                    : [];
                })(t)
              : [].concat(e),
      ...
      function bt(t, e) {
        ...
        var i = e,
          ...
          E = i.padding,
          C = void 0 === E ? 0 : E,
          T = J("number" != typeof C ? C : G(C, c)),
          O = y === p ? g : p,
          x = t.rects.popper,
          k = t.elements[A ? O : y],
          L = mt(S(k) ? k : k.contextElement || $(t.elements.popper), m, b, h),
          D = B(t.elements.reference),
          I = _t({
            reference: D,
            element: x,
            strategy: "absolute",
          ...
          if (x) {
            if (c) {
              var F,
                ...
                nt = U(0, k[B], G[B]),
                st = C
                  ? k[B] / 2 - $ - nt - et - D.mainAxis
                  : K - nt - et - D.mainAxis,
                ot = C
                  ? -k[B] / 2 + $ + nt + it + D.mainAxis
                  : Q + nt + it + D.mainAxis,
                ...
                at = rt
                  ? "y" === T
                    ...
                    : rt.clientLeft || 0
                  : 0,
                lt = null != (F = null == I ? void 0 : I[T]) ? F : 0,
                ct = R + ot - lt,
                ht = U(b ? j(q, R + st - lt - at) : q, R, b ? M(V, ct) : V);
              (x[T] = ht), (N[T] = ht - R);
            }
            if (u) {
              var dt,
                ...
                wt = vt ? mt : pt - k[gt] - L[gt] - yt + D.altAxis,
                At = vt ? pt + k[gt] + L[gt] - yt - D.altAxis : _t,
                Et =
                  b && vt
                    ? (function (t, e, i) {
                        var n = U(t, e, i);
      ...
      var Dt = St(),
        It = St({ defaultModifiers: [ot, Ct, nt, N, Et, vt, Tt, Z, At] }),
        Nt = St({ defaultModifiers: [ot, Ct, nt, N] });
      const Pt = new Map(),
        Mt = {
          set(t, e, i) {
        ...
        Yt = (t, e = [], i = t) => ("function" == typeof t ? t(...e) : i),
        Ut = (t, e, i = !0) => {
          ...
          const o = ({ target: i }) => {
            i === e &&
              ((s = !0), e.removeEventListener("transitionend", o), Yt(t));
          };
      ...
      class be {
        ...
        _mergeConfigObj(t, e) {
          const i = Ht(e) ? _e.getDataAttribute(e, "config") : {};
          return {
      ...
      fe.on(
        ...
        Xt(Ce);
      const Te = { endCallback: null, leftCallback: null, rightCallback: null },
        Oe = {
      ...
      const ke = { ArrowLeft: "right", ArrowRight: "left" },
        Le = {
          interval: 5e3,
          keyboard: !0,
          pause: "hover",
      ...
      class De extends ve {
        ...
        _maybeEnableCycle() {
          this._config.ride &&
            (this._isSliding
              ? fe.one(this._element, "slid.bs.carousel", () => this.cycle())
              : this.cycle());
        }
        to(t) {
          ...
          if (this._isSliding)
            return void fe.one(this._element, "slid.bs.carousel", () =>
              this.to(t)
            );
          const i = this._getItemIndex(this._getActive());
          if (i === t) return;
          const n = t > i ? "next" : "prev";
          this._slide(n, e[t]);
        }
        dispose() {
        ...
        _addTouchEventListeners() {
          ...
          this._swipeHelper = new xe(this._element, t);
        }
        _keydown(t) {
        ...
        _setActiveIndicatorElement(t) {
          ...
          const e = we.findOne(".active", this._indicatorsElement);
          ...
          i &&
            (i.classList.add("active"), i.setAttribute("aria-current", "true"));
        }
        _updateInterval() {
        ...
        _getActive() {
          return we.findOne(".active.carousel-item", this._element);
        }
        _getItems() {
          return we.find(".carousel-item", this._element);
        }
        _clearInterval() {
          this._interval &&
      ...
      fe.on(
        ...
        function (t) {
          ...
          t.preventDefault();
          const i = De.getOrCreateInstance(e),
        ...
        fe.on(window, "load.bs.carousel.data-api", () => {
          ...
          for (const e of t) De.getOrCreateInstance(e);
        }),
        Xt(De);
      const Ie = { parent: null, toggle: !0 },
        Ne = { parent: "(null|element)", toggle: "boolean" };
      class Pe extends ve {
        constructor(t, e) {
          super(t, e), (this._isTransitioning = !1), (this._triggerArray = []);
          const i = we.find('[data-bs-toggle="collapse"]');
          for (const t of i) {
          ...
          if (
            (this._config.parent &&
              (t = this._getFirstLevelChildren(
                ...
                .map((t) => Pe.getOrCreateInstance(t, { toggle: !1 }))),
        ...
        _initializeChildren() {
          ...
          const t = this._getFirstLevelChildren('[data-bs-toggle="collapse"]');
          for (const e of t) {
        ...
        _getFirstLevelChildren(t) {
          const e = we.find(":scope .collapse .collapse", this._config.parent);
      ...
      const Me = "ArrowUp",
        ...
        He = Qt() ? "top-end" : "top-start",
        We = Qt() ? "top-start" : "top-end",
        Be = Qt() ? "bottom-end" : "bottom-start",
        ze = Qt() ? "bottom-start" : "bottom-end",
        Re = Qt() ? "left-start" : "right-start",
        qe = Qt() ? "right-start" : "left-start",
        Ve = {
          autoClose: !0,
      ...
      class Ke extends ve {
        constructor(t, e) {
          super(t, e),
            ...
            (this._menu =
              we.next(this._element, ".dropdown-menu")[0] ||
              we.prev(this._element, ".dropdown-menu")[0] ||
              we.findOne(".dropdown-menu", this._parent)),
        ...
        _getPlacement() {
          ...
          if (t.classList.contains("dropend")) return Re;
          if (t.classList.contains("dropstart")) return qe;
          ...
          const e =
            ...
            getComputedStyle(this._menu)
              ...
              .trim();
          return t.classList.contains("dropup") ? (e ? We : He) : e ? ze : Be;
        }
        _detectNavbar() {
        ...
        _getPopperConfig() {
          ...
          return (
            ...
            { ...t, ...Yt(this._config.popperConfig, [t]) }
          );
        }
        _selectMenuItem({ key: t, target: e }) {
          const i = we
            ...
            .filter((t) => Bt(t));
          i.length && Jt(i, e, t === je, !i.includes(e)).focus();
        }
        static jQueryInterface(t) {
          return this.each(function () {
        ...
        static dataApiKeydownHandler(t) {
          const e = /input|textarea/i.test(t.target.tagName),
            i = "Escape" === t.key,
            n = [Me, je].includes(t.key);
          if (!n && !i) return;
          if (e && !i) return;
          t.preventDefault();
          const s = this.matches(Fe)
              ? this
              : we.prev(this, Fe)[0] ||
                we.next(this, Fe)[0] ||
                we.findOne(Fe, t.delegateTarget.parentNode),
            o = Ke.getOrCreateInstance(s);
          if (n)
      ...
      fe.on(
        ...
        fe.on(document, "click.bs.dropdown.data-api", Ke.clearMenus),
        fe.on(document, "keyup.bs.dropdown.data-api", Ke.clearMenus),
        fe.on(document, "click.bs.dropdown.data-api", Fe, function (t) {
      ...
      class Ye extends be {
        ...
        dispose() {
          this._isAppended &&
            (fe.off(this._element, "mousedown.bs.backdrop"),
            this._element.remove(),
            (this._isAppended = !1));
        }
        _getElement() {
      ...
      const Ue = { autofocus: !0, trapElement: null },
      ...
      class Ge extends be {
        ...
        deactivate() {
          this._isActive &&
            ((this._isActive = !1), fe.off(document, ".bs.focustrap"));
        }
        _handleFocusin(t) {
      ...
      const ti = { backdrop: !0, focus: !0, keyboard: !0 },
        ei = {
      ...
      class ii extends ve {
        ...
        show(t) {
          ...
          fe.trigger(this._element, "show.bs.modal", { relatedTarget: t })
            .defaultPrevented ||
            ((this._isShown = !0),
            (this._isTransitioning = !0),
        ...
        dispose() {
          fe.off(window, ".bs.modal"),
            fe.off(this._dialog, ".bs.modal"),
          ...
          (this._element.style.display = "none"),
            ...
            this._backdrop.hide(() => {
              document.body.classList.remove("modal-open"),
                ...
                fe.trigger(this._element, "hidden.bs.modal");
            });
        }
        _isAnimated() {
      ...
      fe.on(
        ...
        function (t) {
          ...
          ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
            fe.one(e, "show.bs.modal", (t) => {
              t.defaultPrevented ||
                fe.one(e, "hidden.bs.modal", () => {
                  Bt(this) && this.focus();
                });
            });
        ...
        Ae(ii),
        Xt(ii);
      const ni = ".bs.offcanvas",
        si = `load${ni}.data-api`,
        oi = `click${ni}.data-api`,
          ...
          this._queueCallback(
            () => {
              this._element.classList.remove("show", "hiding"),
                ...
                fe.trigger(this._element, "hidden.bs.offcanvas");
            },
            this._element,
            !0
          );
          ...
          return new Ye({
            ...
            clickCallback: t
              ? () => {
                  "static" !== this._config.backdrop
                    ? this.hide()
                    : fe.trigger(this._element, "hidePrevented.bs.offcanvas");
                }
              : null,
          });
        }
      ...
      fe.on(document, oi, '[data-bs-toggle="offcanvas"]', function (t) {
        const e = we.getElementFromSelector(this);
        if (
          (["A", "AREA"].includes(this.tagName) && t.preventDefault(), zt(this))
        )
          return;
        fe.one(e, "hidden.bs.offcanvas", () => {
          Bt(this) && this.focus();
        });
        const i = we.findOne(".offcanvas.show");
        i && i !== e && li.getInstance(i).hide();
        li.getOrCreateInstance(e).toggle(this);
      }),
        fe.on(window, si, () => {
          for (const t of we.find(".offcanvas.show"))
      ...
      const ci = {
        ...
        ui = (t, e) => {
          ...
          return e.includes(i)
            ? !hi.has(i) || Boolean(di.test(t.nodeValue))
      ...
      class mi extends be {
        ...
        _checkContent(t) {
          for (const [e, i] of Object.entries(t))
            super._typeCheckConfig({ selector: e, entry: i }, gi);
        }
        _setContent(t, e, i) {
            ...
            ? (function (t, e, i) {
                ...
                for (const t of s) {
                  ...
                  const n = [].concat(...t.attributes),
                    s = [].concat(e["*"] || [], e[i] || []);
                  for (const e of n) ui(e, s) || t.removeAttribute(e.nodeName);
                }
      ...
      const _i = new Set(["sanitize", "allowList", "sanitizeFn"]),
        bi = {
          AUTO: "auto",
          TOP: "top",
          RIGHT: Qt() ? "left" : "right",
      ...
      class wi extends ve {
        ...
        _getConfig(t) {
          ...
          for (const t of Object.keys(e)) _i.has(t) && delete e[t];
          return (
      ...
      const Ai = {
        ...
        Ei = { ...wi.DefaultType, content: "(null|string|element|function)" };
      class Ci extends wi {
        static get Default() {
          return Ai;
        }
      ...
      class xi extends ve {
        ...
        _maybeEnableSmoothScroll() {
          this._config.smoothScroll &&
            (fe.off(this._config.target, "click.bs.scrollspy"),
            fe.on(this._config.target, "click.bs.scrollspy", "[href]", (t) => {
        ...
        _initializeTargetsAndObservables() {
          (this._targetLinks = new Map()),
            (this._observableSections = new Map());
          const t = we.find("[href]", this._config.target);
          for (const e of t) {
      ...
      class Pi extends ve {
        ...
        show() {
          ...
          fe.trigger(t, "show.bs.tab", { relatedTarget: e }).defaultPrevented ||
        ...
        _keydown(t) {
          if (![ki, Li, Si, Di].includes(t.key)) return;
          t.stopPropagation(), t.preventDefault();
          const e = [Li, Di].includes(t.key),
            i = Jt(
              this._getChildren().filter((t) => !zt(t)),
              t.target,
              e,
              !0
            );
          i &&
            (i.focus({ preventScroll: !0 }), Pi.getOrCreateInstance(i).show());
        }
        _getChildren() {
          return we.find(Ni, this._parent);
        }
        _getActiveElem() {
        ...
        _toggleDropDown(t, e) {
          ...
          n(".dropdown-toggle", "active"),
            n(".dropdown-menu", "show"),
            i.setAttribute("aria-expanded", e);
        }
        ...
        _getInnerElement(t) {
          return t.matches(Ni) ? t : we.findOne(Ni, t);
        }
        _getOuterElement(t) {
        ...
        static jQueryInterface(t) {
          return this.each(function () {
            const e = Pi.getOrCreateInstance(this);
            if ("string" == typeof t) {
              if (void 0 === e[t] || t.startsWith("_") || "constructor" === t)
                throw new TypeError(`No method named "${t}"`);
              e[t]();
      ...
      fe.on(document, "click.bs.tab", Ii, function (t) {
        ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
          zt(this) || Pi.getOrCreateInstance(this).show();
      }),
        ...
        Xt(Pi);
      const Mi = { animation: "boolean", autohide: "boolean", delay: "number" },
